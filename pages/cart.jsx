...
import { OrderDetail } from "@/components/index";
...
const Cart = () => {
  ...
  return (
    <div className={styles.container}>
          ...
          {open ? (
            <div className={styles.paymentMethods}>
              ...
              <PayPalScriptProvider
                options={{
                  "client-id":
                    "AV7jU-4rDgnvFUWi8QEfBOfThtCDH4am1Dqwl8W4n63nMXb4RW_-YkPXBJRnam_rNpJyaEd20Ax3J0mz",
                  components: "buttons",
                  currency: "USD",
      ...
      {cash && <OrderDetail total={amount} createOrder={createOrder} />}
    </div>
  );
};
